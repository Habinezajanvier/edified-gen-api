...
projectRouter.post("/", [_authorization.auth, _authorization.adminAuth], (0, _asyncHandler["default"])(_projects["default"].postProject)).get("/signedUrl", [_authorization.auth, _authorization.adminAuth], (0, _asyncHandler["default"])(_files.getSignedUrl)).get("/", [_authorization.auth, _authorization.adminAuth], (0, _asyncHandler["default"])(_projects["default"].getProjects))["delete"]("/:id", [_authorization.auth, _authorization.adminAuth], (0, _asyncHandler["default"])(_projects["default"].deleteProject)).put("/:id", [_authorization.auth, _authorization.adminAuth], (0, _asyncHandler["default"])(_projects["default"].updateProject));
